...
public interface AutorizationConstants {
  ...
  public static final int IDENTIFIEDGUEST = 2;
  public static final int MEMBER = 32;
  public static final int EXECUTIVEMEMBER = 64;   // permission d'effacer des messages
  public static final int VIPMEMBER = 128; // remise à zéro du forum, permission d'ajouter et de bannir des utilisateurs
  public static final int ADMIN = 256; // permanent
  public static final int ACCOUNTINACTIVE = -1;
  public static final int DELETED = -2;
   public static final int ILLEGAL = -99;
}