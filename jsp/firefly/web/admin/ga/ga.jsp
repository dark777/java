...
function OpenNewWindow(a) {
  window.open(a,'S','toolbar=no,location=no,directories=no,status=no,menubar=no,resizable=no,copyhistory=no,scrollbars=no,width=374,height=383');
}
</script>
...
<%@ include file="../includes/gap1.inl" %>
<p><a href="javascript:OpenNewWindow('../ag/ag1.html')">Add Group</a>
