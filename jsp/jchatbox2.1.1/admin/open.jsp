                            ...
                            <tr>
                              <td>
                                <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#0000FF">
                                  ...
                                  <%
                                	if ((SystemProcessor.getSysMessage()).equals(Conf.CHATROOMNAMEMISSING)) out.print("Chatroom's name missing !");
                                  ...
                                  <table width="65%" border="0" cellspacing="1" cellpadding="0">
                                    ...
                                    <tr>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Name
                                        : <% if ((SystemProcessor.getSysMessage()).equals(Conf.CHATROOMNAMEMISSING)) out.print("<font color=#ff0000>*</font>"); %></font></td>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">
                                    ...
                                    <tr>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Subject
                                        : <% if ((SystemProcessor.getSysMessage()).equals(Conf.CHATROOMSUBJECTMISSING)) out.print("<font color=#ff0000>*</font>"); %></font></td>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">
                                  ...
                                  <table width="65%" border="0" cellspacing="1" cellpadding="0">
                                    ...
                                    <tr>
                                      <td valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Private
                                        messages : </font></td>
                                      <td>
                                  ...
                                  <input type="button" name="Button" value="Open" onClick="validate()">
                                  &nbsp;
                                  <input type="button" name="Cancel" value="Cancel" onClick="cancel()"><input type="hidden" name="todo" value="openchatroom">
                                  </font></div>
                              </td>
                            </tr>
                          </table>
