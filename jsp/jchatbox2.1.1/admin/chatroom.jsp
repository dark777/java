...
<form method="post" action="chatroom.jsp" name="chatroom">
  <p align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><br>
    ...
    <%
 		if ((SystemProcessor.getSysMessage()).equals(Conf.CHATROOMUPDATED)) out.print("Chatroom has been updated successfully.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.CHATROOMTRANSCRIPTED)) out.print("Chatroom has been transcripted successfully.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.CHATROOMSUBJECTMISSING)) out.print("Chatroom's subject missing.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.CHATROOMIDMISSING)) out.print("System error : Chatroom's id missing.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.CHATROOMNOTFOUND)) out.print("System error : Chatroom not found.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.SYSTEMERROR)) out.print("Cannot execute : System error.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.USERNAMEMISSING)) out.print("Username missing.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.NAMENOTFOUND)) out.print("Username not found.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.KICKEDOFF)) out.print("User has been kicked off this chatroom.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.BANNED)) out.print("User has been banned of this chatroom.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.CHATROOMBLACKLISTCLEARED)) out.print("Blacklist cleared.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.IPREMOVED)) out.print("IP removed from blacklist.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.CANNOTKICKOFFORBAN)) out.print("Cannot kick off or ban SYSTEM user.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.NAMENOTAVAILABLE)) out.print("Name already in use for this charoom.");
 		else if ((SystemProcessor.getSysMessage()).equals(Conf.SYSTEMUSERJOINED))
 		{
 			out.print("SYSTEM user has joined this chatroom.");
 			out.print(" Try <a href=\"../skin_mirc/room.jsp\" target=\"_blank\" class=\"bluelink\">this URL</a> to enter this chatroom.<br>");
 		}
 		else out.print(SystemProcessor.getSysMessage());
    %>
    </b></font></p>
                            ...
                            <tr>
                              <td>
                                <div align="center">
                                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                    <tr>
                                      <td bgcolor="#EEEEEE"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b><font color="#000099"><a href="javascript:close()" class="bluelink">Close</a>&nbsp;|&nbsp;<a href="javascript:join()" class="bluelink">Join</a>&nbsp;</font></b></font></td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <hr size="1" width="100%">
                                  ...
                                  <table width="100%%" border="0" cellspacing="1" cellpadding="0">
                                    ...
                                    <tr>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b>Name
                                        : </b></font></td>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><% if (aChatroom != null) out.print(aChatroom.getParams().getName()); %></font></td>
                                        ...
                                        <select name="refreshlimit" class="SystemBox">
										  ...
										  if (aChatroom != null)
										  {
                                          	...
                                          	for (int r=0;r<refreshList.length;r++)
                                          	{
                                          	   ...
                                          	   %>
	                                          <option value="<%= rStr %>"<%= Select %>><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><%= rStr %> seconds</font></option>
                                          <%}
                                          }
                                         %>
                                        </select>
                                    ...
                                    <tr>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b>Max.
                                        users :</b></font></td>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><% if (aChatroom != null) out.print(aChatroom.getParams().getMaxUsers()); %></font></td>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b>Refresh
                                        model : </b></font></td>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">
                                    ...
                                    <tr>
                                      <td align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">
                                        <input type="button" name="Update" value="Update" class="SystemBox" onClick="update()">
                                        </font></td>
                                  ...
                                  <table width="100%%" border="0" cellspacing="1" cellpadding="0">
                                    ...
                                    <tr>
                                      <td><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><b>&nbsp;Filename
                                        ...
                                        <input type="button" name="Generate" value="Generate" class="SystemBox" onClick="generate()">
